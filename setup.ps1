...
Write-Host ""
Write-Host "Primeiro acesso / administrador inicial:"
Write-Host "  Abra http://127.0.0.1:8000/ neste computador."
Write-Host "  Se nao houver administrador, o proprio site exibira o cadastro inicial."
Write-Host ""
